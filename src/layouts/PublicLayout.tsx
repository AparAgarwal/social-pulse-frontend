...
export function PublicLayout() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b border-white/5 bg-surface/40 backdrop-blur-xl fixed top-0 w-full z-50 px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6 text-sm font-medium">
          ...
          <Link to="/register" className="bg-primary-600 hover:bg-primary-500 text-white px-5 py-2.5 rounded-lg transition-all shadow-[0_0_10px_rgba(14,165,233,0.3)] hover:shadow-[0_0_20px_rgba(14,165,233,0.5)] hover:-translate-y-0.5">
            Sign up
          </Link>
        </nav>
      </header>
